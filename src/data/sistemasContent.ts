      ...
      items: [
        ...
        },
        {
          ...
          subitems: [
            {
              name: "Fontes de Dano",
              description: "Ataques comuns e Técnicas Ofensivas possuirão formas diferentes de composição.",
              descrip1: "Ataques comuns utilizarão normalmente as fórmulas estabelecidas para cada estilo de combate.",
              descrip2: "Ao utilizar uma Técnica Ofensiva, deverá ser respeitada a regra estabelecida pelo Sistema Geral de Escalonamento de Técnicas:",
              details2: [
                "Dano Técnico + até 2 Fontes Numéricas Adicionais."
              ],
              descrip3: "Poderão funcionar como Fontes Numéricas Adicionais, quando aplicáveis:",
              details3: [
                "Força.",
                "Destreza.",
              ...
              descrip5: "Exemplo inválido:",
              details5: [
                "Técnica + Força + Espada + Haki."
              ],
              additional5: "OBS - Qualquer valor adicionado diretamente ao dano de uma Técnica será considerado uma Fonte Numérica Adicional, salvo quando outra regra estabelecer expressamente o contrário."
            },
            {
              name: "Porradeiros",
              ...
              descrip2: "Os 50% da Destreza utilizados nos ataques comuns não serão adicionados automaticamente quando uma Técnica Ofensiva estiver sendo utilizada.",
              additional2: "OBS - Caso determinada Técnica possua funcionamento baseado em outro atributo, isso deverá estar previsto em sua descrição."
            },
            {
              name: "Espadachins",
              ...
              descrip2: "O Dano Base da arma não será substituído obrigatoriamente pelo Dano Técnico.",
              descrip3: "Quando utilizado juntamente à Técnica, o Dano Base da arma ocupará uma das duas Fontes Numéricas Adicionais disponíveis.",
              additional3: "OBS - Efeitos especiais e características próprias de determinadas armas continuarão funcionando conforme suas respectivas descrições. Caso acrescentem diretamente um novo valor numérico ao dano, deverão respeitar as limitações do Sistema de Técnicas."
            },
            {
              name: "Atiradores",
              ...
              descrip2: "Destreza + 50% da Velocidade + Haki não serão adicionados simultaneamente ao Dano Técnico.",
              descrip3: "Projéteis poderão ser revestidos normalmente através do Koka.",
              descrip4: "A utilização de Emissão ou Destruição Interna através de projéteis dependerá de Técnica, arma ou efeito que permita expressamente essa aplicação.",
              subitems: [
                {
                  name: "Alcance",
  ...
  "Organizações": {
    ...
    "Marinha": {
      ...
      items: [
        ...
        { name: "CABO", description: "Cabo é uma patente que o torna responsável por certos deveres, como patrulhas diárias em grupo, policiamento da base e dos portos. Contudo, ainda não é autorizado a solicitar transferência de ilha.", details: ["Salário: 25.000.000", "Nível: 10"] },
        { name: "SARGENTO", description: "Agora que chegou até aqui, é natural sentir certa ansiedade para partir rumo a outras ilhas e enfrentar piratas. A partir deste posto, já é permitido navegar para outros territórios. Caso não seja um navegador, a Marinha disponibiliza um navio e uma tripulação.", details: ["Salário: 50.000.000", "Nível: 20"] },
        { name: "TENENTE", description: "Um Tenente da Marinha é um cargo extremamente respeitável nos Blues. Como Tenente, você passa a caçar cada vez mais piratas, levando-os à prisão e fazendo a Justiça ser cumprida. Tome cuidado: alguns piratas irão querer matá-lo para fazer um bom nome.", details: ["Salário: 100.000.000", "Nível: 30"] },
        { name: "COMANDANTE", description: "Um Comandante é algo extremamente forte, um nome temido pelos piratas dos Blues. Isso significa que já não é mais possível permanecer nessas águas, devendo partir para a Grande Rota, caso ainda não o tenha feito.", details: ["Salário: 175.000.000", "Nível: 40"] },
        { name: "CAPITÃO", description: "Um Capitão é uma patente temida nos Blues e reconhecida na Grande Rota. Com ela, já é possível ter sob suas ordens um navio forte e bons soldados, desde que haja autorização de superiores.", details: ["Salário: 250.000.000", "Nível: 50"] },
        { name: "COMODORO", description: "Já deve ter navegado por boa parte da Grande Rota e ter chegado na Red Line. O Comodoro é um vão que há entre as forças da Marinha de patentes para chegar no almirantado. A partir daqui, é preciso ser reconhecido.", details: ["Salário: 350.000.000", "Nível: 60"] },
        { name: "CONTRA-ALMIRANTE", description: "Esse posto é frequentemente ridicularizado na obra, assim como boa parte da Marinha, mas aqui optamos por lhe conceder o devido respeito, colocando-o em uma posição de prestígio.", details: ["Salário: 500.000.000", "Nível: 70"] },
        { name: "VICE-ALMIRANTE", description: "Esse cargo é extremamente respeitado e reconhecido na Marinha. Nele, aprendemos em One Piece que títulos nem sempre significam tudo, pois Garp, mesmo sendo apenas um Vice-Almirante, está muito além de Smoker.", details: ["Salário: 750.000.000", "Nível: 80", "Requisitos: Ter Dominado uma Ilha"] },
        { name: "DIVISÃO SSG", description: "A SSG é uma divisão científica da Marinha que fica em uma ilha secreta. Apenas os Vice-Almirantes, Almirantes e o Almirante de Frota sabem sua verdadeira localização. É nessa divisão que as grandes soluções para acabar com os piratas e as armas da Marinha são criadas.", details: ["Salário: 850.000.000", "Nível: 80+", "Requisitos: Classe Cientista ou Inventor. Possuir o conhecimento do Século Perdido", "Dr. Newthug (NPC)", "VAGA", "VAGA"] },
        { name: "ALMIRANTE", description: "Os três Almirantes são um grupo de homens ou mulheres que estão no eixo entre os pilares de poder da Marinha. São poderosos o bastante para enfrentarem um dos Yonkous no mano a mano, extremamente inteligentes ao realizar ações táticas ou ardilosas para vencer uma guerra. Se para se tornar um Vice-Almirante é preciso derrotar um pirata no Novo Mundo, tornar-se um Almirante exige derrotar uma tripulação, libertar uma ilha ou até mesmo um reino.", details: ["Salário: 1.000.000.000", "Nível: 90", "Requisito: Feitos na Grand Line e no Novo Mundo", "Shin-Hei Sanshuō — Olsen (NPC)", "Ernesto Garnier — Shi'Hogane (NPC)", "Gyutan Laverger — Bosílio (NPC)"] },
        { name: "ALMIRANTE DE FROTA", description: "O Almirante de Frota é o Fuzileiro Naval mais poderoso, abaixo apenas do Almirante Supremo. É ele quem desempenha o papel de sustentar a Justiça no mundo. Shichibukai não são aceitos sem o seu aval, recompensas não são concedidas sem o seu consentimento; absolutamente nada é feito sem que ele saiba ou permita. O lema da Marinha é \"Justiça Moral\".", details: ["Salário: 1.500.000.000", "Nível: 100", "Requisitos: Ter enfrentado um Yonkou de igual", "John Grenfell Belfort — O Brando (NPC)"] }
      ]
    },
    "Shichibukai": {
      ...
      items: [
        {
          ...
          subitems: [
            { name: "CP1", details: ["Salário: 10.000.000", "Nível: 1-10"] },
            { name: "CP2", details: ["Salário: 20.000.000", "Nível: 11-20"] },
            { name: "CP3", details: ["Salário: 70.000.000", "Nível: 21-30"] },
            { name: "CP4", details: ["Salário: 140.000.000", "Nível: 31-40"] },
            { name: "CP5", details: ["Salário: 200.000.000", "Nível: 41-50"] },
            { name: "CP6", details: ["Salário: 250.000.000", "Nível: 51-60"] },
            { name: "CP7", details: ["Salário: 300.000.000", "Nível: 61-70"] },
            { name: "CP8", details: ["Salário: 350.000.000", "Nível: 71-80"] },
            { name: "CP9", details: ["Salário: 450.000.000", "Nível: 81-90"] },
            { name: "CP0", details: ["Salário: 700.000.000", "Nível: 91-100"] },
            {
              name: "Obs: CP1 a CP8",
    ...
    "Revolucionário": {
      ...
      items: [
        ...
        { name: "MAJOR", description: "Você agora é uma figura reconhecida dentro do Exército Revolucionário. Além de comandar soldados, recrutas e sargentos, você possui duas bases próprias para recrutar e convencer pessoas a se unirem à sua causa.", details: ["Salário: 350.000.000", "Nível: 60"] },
        {
          ...
          subitems: [
            { name: "Comandante do Leste", description: "Responsável por liderar a revolução no East Blue, enfrentando diretamente o Major de Blue. O Comando do Leste é especializado em assaltos, formado por brutamontes habilidosos e destemidos.", details: ["Lusia Hirumei (NPC)", "Salário: 650.000.000", "Nível: Merecimento"] },
            { name: "Comandante do Oeste", description: "Esse comando atua no West Blue e é conhecido por causar grandes entradas, sempre com muito barulho. São semelhantes ao Comando do Leste, mas preferem explodir as coisas.", details: ["Kagami Miyamoto (NPC)", "Salário: 650.000.000", "Nível: Merecimento"] },
            { name: "Comandante do Sul", description: "Foca mais em espionagem. Seus membros trabalham com infiltração e exploram a sutileza dos detalhes. São pessoas misteriosas e altamente estratégicas.", details: ["Hichikatsu (NPC)", "Salário: 650.000.000", "Nível: Merecimento"] },
            { name: "Comandante do Norte", description: "Este é o grupo de pesquisa e desenvolvimento do Exército Revolucionário. Altamente ultrassecreto, qualquer informação vazada para a Marinha será severamente perseguida.", details: ["Satoro Rakushō (NPC)", "Salário: 650.000.000", "Nível: Merecimento"] }
          ]
        },
    ...
    "Baroque Works": {
      ...
      items: [
        ...
        { name: "Billions", description: "Os Billions são soldados subordinados diretamente aos agentes cujo número supera o 5, podendo alcançar uma alta patente em caso da morte de um agente.", details: ["Salário: 15.000.000", "Nível: 5"] },
        {
        ...
        { name: "Mr. 12 e Miss Saturday", description: "O Primeiro Par de agentes é considerado o mais fraco da Baroque Works, mas ainda assim o mais promissor. Recebem Procurados de nível 1 a 2.", details: ["Salário: 30.000.000", "Nível: 10", "Benefício: Recompensa pela cabeça dos Procurados (-40%)", "VAGO ×2"] },
        { name: "Mr. 11 e Miss Thursday", description: "Agentes Intermediários, considerados promissores dentro da Baroque Works. Função principal é executar missões e caçadas de nível 2.", details: ["Salário: 70.000.000", "Nível: 20", "Benefício: Recompensa pela cabeça dos Procurados (-30%)"] },
        { name: "Mr. 10 e Miss Tuesday", description: "A partir deste ponto, vocês já podem se denominar agentes da Baroque Works. Os Billions e Millions estão sob seu comando — podem recrutar até 100 deles para auxiliá-los em suas missões.", details: ["Salário: 130.000.000", "Nível: 30", "Benefício: Recompensa (-30%) + Até 100 bots (LvL 50)", "VAGO ×2"] },
        { name: "Mr. 9 e Miss Wednesday", description: "Conforme ele se aproxima dos números abaixo de 5, seu cargo se torna visado dentro da organização, e qualquer deslize pode significar sua morte.", details: ["Salário: 200.000.000", "Nível: 35", "Benefício: Recompensa (-30%) + Até 150 bots (LvL 50)", "VAGO ×2"] },
        { name: "Mr. 8 e Miss Monday", description: "Os Mr. 8 e Miss Monday são líderes dos Misters menores e desempenham um papel crucial na coordenação dos Billions e Millions. Missões normalmente de Nível 4 a 5.", details: ["Salário: 300.000.000", "Nível: 40", "Benefício: Recompensa (-30%) + Até 200 bots (LvL 50)", "VAGO ×2"] },
        { name: "Mr. 7 e Miss Father's Days", description: "Agentes de Missões Secretas, geralmente contratados para agir nas sombras. Se algo precisa explodir, são eles que plantam a bomba; se alguém deve morrer em silêncio, são eles que executam.", details: ["Salário: 400.000.000", "Nível: 45", "Benefício: Recompensa (-20%) + Até 100 bots (LvL 100)", "VAGO ×2"] },
        { name: "Mr. 6 e Miss Mother's Days", description: "Estes agentes são mestres na arte da infiltração. Podem passar dias, meses ou até anos inseridos em organizações e reinos. A espionagem é a especialidade desses agentes.", details: ["Salário: 450.000.000", "Nível: 50", "Benefício: Recompensa (-20%) + Até 100 bots (LvL 100)", "VAGO ×2"] },
        {
        ...
        { name: "Mr. 5 e Miss Valentine Days", description: "Só são enviados em casos de extrema necessidade. Missões de Nível 5 ao 6 mediano.", details: ["Salário: 550.000.000", "Requisitos: nivel 60 + Merecimento", "Benefício: Recompensa (-10%) + Até 150 bots (LvL 100)", "Kaigun Pascoe (NPC) / Maria Romuri (NPC)"] },
        { name: "Mr. 4 e Miss Merry Christmas", description: "O medo não se faz mais presente aqui. Missões de Nível 6 extremo ao 7.", details: ["Salário: 650.000.000", "Requisitos: nivel 70 + Merecimento", "Benefício: Recompensa (-10%) + Até 200 bots (LvL 100)", "Choso Bial (NPC) / Yuhime Saiko (NPC)"] },
        { name: "Mr. 3 e Miss Golden Week", description: "Agentes de Campo Veteranos — lendas no Submundo. Recebem missões de extrema importância, como dominações de reinos. Missões Nível 7 ao 8.", details: ["Salário: 750.000.000", "Requisitos: nivel 80 + Merecimento", "Benefício: Recompensa + Até 1000 bots (LvL 150)", "Tenshi Orugawa (NPC) / Ruby Sayuri (NPC)"] },
        { name: "Mr. 2", description: "Este agente costuma agir sozinho, dispondo de navios e muitos Billions/Millions. Caçadas de Nível 9 a 10.", details: ["Salário: 850.000.000", "Requisitos: nivel 90 + Merecimento", "Benefício: Recompensa + Até 5000 bots (LvL 150) + Navio fornecido", "Haizō Helsey (NPC)"] },
        { name: "Mr. 1 e Miss Double Finger", description: "O último estágio antes do Grande Chefe — os agentes Superiores, os mais fortes e de importância considerável. Sua força é preparada para rivalizar com as forças supremas deste mundo.", details: ["Salário: 1.000.000.000", "Requisitos: nivel 95 + Merecimento", "Benefício: Recompensa + Até 5000 bots (LvL 150) + Navio fornecido", "Yohan Musashi (NPC) / Misaki Hayakawa (NPC)"] },
        { name: "Mr. 0 e Miss All-Sunday", description: "O Mister Zero é a mente brilhante por trás de toda a organização. Ele é a força suprema que comanda todos os agentes, mantendo sua identidade oculta por meio de um \"rosto falso\". Miss All-Sunday exerce o papel de rosto público da Organização.", details: ["Salário: 1.200.000.000", "Requisitos: nivel 100 + Merecimento", "Benefício Geral", "??? / Donquixote Grace O'Malley (NPC)"] }
      ]
    }
  },
  "Mecânicas do RPG": {
