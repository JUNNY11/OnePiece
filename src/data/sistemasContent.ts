      ...
      items: [
        {
          ...
          subitems: [
            ...
            {
              name: "Percepção",
              description: "A percepção é um subatributo cuja função está ligada à determinação do nível de percepção visual e sensorial de determinado personagem. Ela abrange aspectos importantes, como a capacidade de reação do personagem em relação aos movimentos alheios. A percepção é um atributo derivado da velocidade do personagem, pois, quanto mais veloz ele for, maior será sua capacidade de compreender os estímulos sensoriais ao seu redor. Porém, em One Piece, existe uma variável adicional: o Haki da Observação. O Haki da Observação contribui significativamente para o aumento da percepção, refinando a leitura de movimentos, intenções e presenças ao ponto de ultrapassar os limites naturais dos sentidos. Todavia, deve haver equilíbrio para evitar uma disparidade entre velocidade e Kenbunshoku. Em outras palavras, não é porque você possui uma elevada capacidade de percepção, ou seja, consegue perceber um movimento ofensivo, que necessariamente terá capacidade para reagir a ele. Você não se torna imune por possuir um alto nível de percepção; apenas adquire as condições necessárias para visualizar o movimento e, assim, tentar reagir a ele.",
            },
            {
        ...
        },
        {
          ...
          subitems: [
            ...
            },
            {
              ...
              additional1: "Recuperação por alimentação (Cozinheiros)",
              descrip1: "A comida ocupa um papel central na recuperação de Estamina, refletindo a tradição culinária de One Piece, pois um bom prato alimenta e devolve fôlego para a batalha. Por isso, entre as classes de suporte, o Cozinheiro carrega a maior responsabilidade na recuperação desse recurso.",
              details2: [
